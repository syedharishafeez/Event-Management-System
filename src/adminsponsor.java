 ...
 * @author A.R COM
 */
public class adminsponsor extends javax.swing.JFrame {
    ...
    public adminsponsor(String a) {
        initComponents();
        r2=a;
    }
    public adminsponsor(String a,String c) {
        initComponents();
        r3=a;
        r2=c;
    }
    public adminsponsor(String a, String b,String c) {
        initComponents();
        r1=b;
        r3=a;
        r2=c;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((t.equalsIgnoreCase(s1))||(t.equalsIgnoreCase(s2))||(t.equalsIgnoreCase(s3))){
            ...
            if(s1.equalsIgnoreCase(t)){
                if(p1.equals(p)){
                    if(r2.equals("i")){
                        insertsponsor obj=new insertsponsor(r3);
                        obj.setVisible(true);
                        dispose();
                    }
                    if(r2.equals("d")){
                        deletesponsor ds=new deletesponsor(r3);
                        ds.setVisible(true);
                        dispose();
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminsponsor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminsponsor().setVisible(true);
            }
        });
    }
